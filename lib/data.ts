...
export const STORY = {
  intro: [
    ...
    'Previously, production agents at Thena and sleep EEG research at IIT Delhi. Away from the screen, I take my camera on treks.',
  ],
  about: [
...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    image: '/images/covers/dementia.jpg',
    category: 'Healthcare',
    tags: ['SVM', 'Healthcare'],
    links: [
...
export const PHOTOGRAPHY = [
  {
    id: 'confluence',
    src: '/images/photography/confluence.jpg',
    alt: 'Devprayag, where two rivers meet in a steep valley',
    title: 'Devprayag',
    note: 'Stopped above town for this. Two colours of water.',
    aspect: '3/2',
  },
  {
    id: 'flute',
    src: '/images/photography/flute.jpg',
    alt: 'A musician playing flute into a microphone at night',
    title: 'Flute',
    note: 'Caught him after the crowd thinned. Sprite bottle still there.',
    aspect: '2/3',
  },
  {
    id: 'kudremukh',
    src: '/images/photography/kudremukh.jpg',
    alt: 'Green grassland dropping into a shola forest patch, Kudremukh',
    title: 'Kudremukh',
    note: 'The colour is not a filter.',
    aspect: '16/7',
  },
  {
    id: 'hampi',
    src: '/images/photography/hampi.jpg',
    alt: 'Gnarled tree in front of Lotus Mahal, Hampi',
    title: 'Hampi',
    note: 'Lotus Mahal is behind the tree, if you care.',
    aspect: '9/16',
  },
  {
    id: 'aarti',
    src: '/images/photography/aarti.jpg',
    alt: 'Priests in a line holding fire lamps during Ganga aarti',
    title: 'Aarti',
    note: 'Phones in the front row.',
    aspect: '3/2',
  },
  {
    id: 'pondicherry',
    src: '/images/photography/pondicherry.jpg',
    alt: 'Black stone sculpture with a gold sphere, Pondicherry',
    title: 'Pondi',
    note: 'October. No idea who made it.',
    aspect: '4/3',
  },
  {
    id: 'kuari-night',
    src: '/images/photography/kuari-night.jpg',
    alt: 'Snow peaks and a lit village at night, Kuari Pass',
    title: 'Kuari',
    note: 'Long exposure from camp. Village still on.',
    aspect: '3/2',
  },
  {
    id: 'nag-tibba',
    src: '/images/photography/nag-tibba.jpg',
    alt: 'A goat at a terraced hillside under a clear sky, Nag Tibba',
    title: 'Nag Tibba',
    note: 'The goat walked in. Jan 2023.',
    aspect: '4/3',
  },
  {
    id: 'netravati',
    src: '/images/photography/netravati.jpg',
    alt: 'A river running through dense forest, Netravati trek',
    title: 'Netravati',
    note: 'Overcast. The water barely moved.',
    aspect: '16/7',
  },
] as const;
