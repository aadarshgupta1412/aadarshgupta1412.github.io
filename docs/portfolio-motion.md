...
A single low-opacity shimmer crosses the silk during the cover/reveal, clipped to its outline and using the existing text colour. It shares cancellation and reduced-motion handling with the trick.
